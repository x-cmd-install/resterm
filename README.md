...
- **Releases**: 213 · **Merged PRs**: 364 · **Open PRs**: 0 · **Closed issues**: 38 · **Open issues**: 0 · **Commits**: 1390
...
Reported by **7** distros on [repology.org](https://repology.org/project/resterm). **4** are ✅ on the latest upstream release, **2** are ⚠️ on an older version.

| Distro | Version | Status |
|--------|---------|--------|
| Homebrew | `1.7.2` | ✅ latest |
| Nix unstable | `1.5.0` | ⚠️ outdated |
